...
const Terms = () => {
	return (
		<div className="p-8 md:w-2/3 m-auto">
			<h1 className="text-3xl text-center my-5">Privacy Policy</h1>
			...
			<h2 className='text-2xl text-center my-5'>Interpretation and Definitions</h2>
			<h3 className='text-xl text-center my-5'>Interpretation</h3>
			<p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
			<h3 className='text-xl text-center my-5'>Definitions</h3>
			...
			<ul className='list-disc'>
				...
				<li><strong>Organization&nbsp;</strong>(referred to as either "the Organization ", "We", "Us" or "Our" in this Agreement) refers to Multiverse Researchers.</li>
				<li>
				...
				<li>
					<p><strong>Website</strong> refers to Multiverse Researchers, accessible from <a href="https://multiverseresearchers.org/" target="_blank" rel="external nofollow noopener">https://multiverseresearchers.org/</a></p>
				</li>
				<li>
			...
			<h2 className="text-2xl text-center my-5">Collecting and Using Your Personal Data</h2>
			<h3 className="text-xl text-center my-5">Types of Data Collected</h3>
			<h4 className="text-lg text-center my-5">Personal Data</h4>
			...
			<h4 className='text-lg text-center my-5'>Usage Data</h4>
			...
			<p>&nbsp;</p>
			<h4 className='text-lg text-center my-5'>Tracking Technologies and Cookies</h4>
			...
			<h3 className='text-xl text-center my-5'>Use of Your Personal Data</h3>
			...
			<ul className='list-disc'>
				...
				<li><strong>For business transfers:</strong> We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Organization assets, financing, or acquisition of all or a portion of Our business to another Organization.</li>
			...
			<h3 className='text-xl text-center my-5'>Retention of Your Personal Data</h3>
			...
			<h3 className='text-xl text-center my-5'>Transfer of Your Personal Data</h3>
			...
			<h3 className='text-xl text-center my-5'>Delete Your Personal Data</h3>
			...
			<h3 className='text-xl text-center my-5'>Disclosure of Your Personal Data</h3>
			<h4 className='text-lg text-center my-5'>Business Transactions</h4>
			...
			<h4 className='text-lg text-center my-5'>Law enforcement</h4>
			...
			<h4 className='text-lg text-center my-5'>Other legal requirements</h4>
			...
			<h3 className='text-xl text-center my-5'>Security of Your Personal Data</h3>
			<p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
			<h2 className='text-2xl text-center my-5'>Children's Privacy</h2>
			...
			<h2 className='text-2xl text-center my-5'>Links to Other Websites</h2>
			<p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
			<p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
			<h2 className='text-2xl text-center my-5'>Changes to this Privacy Policy</h2>
			<p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.</p>
			<p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the "Last updated" date at the top of this Privacy Policy.</p>
			<p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
			<h2 className='text-2xl text-center my-5'>Contact Us</h2>
			<p>If you have any questions about this Privacy Policy, You can contact us by email: multiverseresearchers@gmail.com</p>
