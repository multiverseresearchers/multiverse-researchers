...
const Home = () => {
    ...
    <div className="bg-[url('/imgs/filler/Background.png')] pb-32" style={backgroundWrapping}>
            <div className='flex flex-col w-full h-[84vh] items-center justify-evenly'>
                ...
                <a href="https://discord.com/invite/PRpxZ6UBNN" target="_blank"><div className="text-lg bg-pink-300 hover:bg-pink-900 hover:text-white transition-colors duration-300 rounded-full py-2 px-6 cursor-pointer my-4">JOIN US</div></a>
            </div>
