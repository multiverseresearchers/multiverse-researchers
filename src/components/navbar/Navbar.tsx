		...
		<nav>
			<div className='flex flex-row items-center justify-between p-4 h-fit lg:px-8'>
				...
				<ul className='hidden lg:flex flex-row gap-8 items-center'>
                    ...
                    <a className='font-bold' href="https://daztyxpv.formester.com/f/6e4ea898-ec48-41c9-9570-fbe35facdc17" target="_blank"><div className='bg-pink-300 rounded-full py-4 px-8 hover:bg-pink-900 hover:text-white transition-colors duration-300 cursor-pointer'>JOIN</div></a>
